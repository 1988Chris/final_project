  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSite">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="index.php" title="inicio"><b>INÍCIO</b></a>
            </li>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              <a href="" class="nav-link"  data-toggle="dropdown" id="navDrop"><i class="fas fa-user" title="login"></i><b>LOGIN</b></a>
                <div class="dropdown-menu">
                <form action="crudilogin.php" method="post">
                  <div class="form-group dropdown-item">
                    <label for="inputNome">E-MAIL DO USUÁRIO</label>
                    <input type="text" name="login" id="inputNome" class="form-control" title="nome usuario">
                  </div>
                  <div class="form-group dropdown-item">
                    <label for="inputPass">SENHA</label>
                    <input name="senha" type="password" id="inputPass" class="form-control" title="senha usuario">
                  </div>
  				        <div class="form-group text-center">
                    <div class="col-12">
                      <button class="btn btn-success" title="entrar"><b>ENTRAR</b></button>
                    </div>
  				        </div>
                </div>
               </form> 
            </li>
              <a href="" class="nav-link mr-4" data-toggle="modal" data-target="#siteModal" title="cadastre-se"><i class="fas fa-pencil-alt"></i><b>CADASTRE-SE</b></a>
          </ul>
			
          <form action="pesquisar.php" class="form-inline" name="pesquisar" method="post">
            <input type="text" class="form-control col-6 mr-2" placeholder="Buscar..." name="pesquisar" title="pesquisar">
    ...
    <div id="carouselSite" class="carousel slide mt-2" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img class="img-fluid d-block" src="img/typescript.png" alt="TYPESCRIPT">
          <div class="carousel-caption d-none d-md-block"></div>
        </div>
        <div class="carousel-item">
                ...
                <div class="col-sm-12 col-md-10 col-lg-8">  <!-- Col Ini -->
                  <form action="crudicadastro.php" method="post"> <!-- Form Ini -->
                    <div class="form-row mt-4"> <!-- Form-row 1 -->
                      ...
                      <input type="text" class="form-control" id="inputNome" placeholder="Primeiro nome" name="nome" title="Coloque seu nome aqui" required>
                      </div>
                      <div class="col-sm-6 form-group">     
                      <label for="inputSobrenome">Sobrenome</label>
                      <input type="text" class="form-control" id="inputSobrenome" placeholder="Sobrenome" name="sobrenome" required>
                      </div>
                    </div> <!-- /Form-row 1 -->
                    <div class="form-row">
                      <div class="col-sm-6 form-group">
                      <label for="inputLog">E-mail (para entrar no site)</label>
                      <input type="email" class="form-control" id="inputLog" placeholder="Seu E-mail" name="login" required>
                      </div>
                      <div class="col-sm-6 form-group">
                        <label for="inputPass">Senha (para entrar no site)</label>
                        <input type="password" class="form-control" id="inputPass" placeholder="Sua senha" name="senha" required>
                      </div>
                    </div>
                    <div class="form-row"> <!-- Form-row 2 -->
                      <div class="form-group col-sm-3">  
                      <label for="inputAge">Idade</label>
                      <input type="number" class="form-control" id="inputAge" placeholder="Sua idade" maxlenght="2" name="idade" required>
                      </div>
                    </div>
                    <div class="form-row"> <!-- Form-row 2 -->
                    ...
                    <div class="form-row"> <!-- Form-row 3 -->
                      ...
                      <input type="text" class="form-control" id="inputCid" placeholder="Sua Cidade" name="cidade" required>
                      </div>

...
<html lang="pt-br">
  <head>
    ...
    <title>Comprar Cursos - Programação P&C</title>
    <?php 
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSite">
          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle mr-3"  data-toggle="dropdown" id="navDrop"><i class="far fa-user-circle"></i><b>OLÁ, <?php echo $logado ?></b></a>
                <div class="dropdown-menu">
          ...
          <form action="pesquisar.php" class="form-inline" method="post">
            <input type="search" class="form-control col-6 "  placeholder="Buscar..." name="pesquisar">
